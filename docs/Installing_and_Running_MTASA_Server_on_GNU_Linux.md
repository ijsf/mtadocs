...
-   If you are using the inbuilt MySQL functions such as [dbConnect](/dbConnect.md "wikilink") and [dbQuery](/dbQuery.md "wikilink"), you will need to have **libmysqlclient.so.16** installed.
...
[`Image:Core.png`](/Image:Core.png.md "wikilink")
