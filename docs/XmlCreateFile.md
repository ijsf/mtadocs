This function creates a new XML document, which can later be saved to a file by using [xmlSaveFile](/xmlSaveFile.md "wikilink"). This function will overwrite the file specified if it already exists.
