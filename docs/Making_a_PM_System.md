...
XML is another language, so I won't teach you much about it. But to learn more about the meta.xml file, visit [this page](/Meta.xml.md "wikilink"). So type the following code into the file.
