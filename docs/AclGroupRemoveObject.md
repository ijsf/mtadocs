This function removes the given object (string) from the given ACL group. The object can be a resource or a player. See [aclGroupAddObject](/aclGroupAddObject.md "wikilink") for more details.
