This function replaces the collision file of the given model id to the collision file passed. Use [engineLoadCOL](/engineLoadCOL.md "wikilink") to load the collision file first.
