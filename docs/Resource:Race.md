...
You can create race maps using the new MTA:SA [map editor](/Resource:editor.md "wikilink"). The map syntax is given here for reference.
...
[ru:<Resource:Race>](/ru:Resource:Race.md "wikilink")
